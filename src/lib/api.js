...
export const api = {
  ...
  builder: {
    ...
    setImage: (country, region, place, url, credit, extra = {}) => req('POST', `/builder?action=setimage&country=${country}&region=${region}&place=${place}`, { url, credit, ...extra }),
  ...
  gallery: {
    ...
    publish: (tripId, attribution, cover, dayNotes) => req('POST', '/gallery?action=publish', { tripId, attribution, cover, dayNotes }),
